...
import ssoRoutes from './api/sso.js';
...
async function ensureEmployeeProfilesTable() {
  try {
    ...
    const newCols = [
      "homePhone VARCHAR(50)", "cellPhone VARCHAR(50)", "emailAddress VARCHAR(255)",
      "sssId VARCHAR(50)", "maritalStatus VARCHAR(20)",
      "spouseName VARCHAR(255)", "spouseEmployer VARCHAR(255)", "spouseWorkPhone VARCHAR(50)",
      "jobTitle VARCHAR(255)", "supervisor VARCHAR(255)", "client VARCHAR(255)",
      "workEmail VARCHAR(255)", "workCellPhone VARCHAR(50)", "salary DECIMAL(12,2)",
      "emergencyContactAddress VARCHAR(500)", "emergencyContactCell VARCHAR(50)",
      "wiseUsername VARCHAR(255)",
      "ref1Name VARCHAR(255)", "ref1Phone VARCHAR(50)", "ref1Relationship VARCHAR(100)",
